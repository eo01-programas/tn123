(() => {
    ...
    // Fecha | cliente | OP-PTDA | color | articulo | kg | Tipo | Turno | MAQ | Status
    const ACAB_ESPEC_WIDTHS_PROCESADO = [75, 50, 71, 80, 250, 78, 78, 70, 65, 70];
    ...
    function renderTable(records, state) {
        ...
        if (theadRow) {
            theadRow.innerHTML = isProcessado
                ? `<th>Fecha</th><th>cliente</th><th>OP-PTDA</th><th>color</th><th>articulo</th><th>kg(crudo)</th><th>Tipo</th><th>Turno</th><th>MAQ</th><th>Status</th>`
                : `<th>P</th><th>cliente</th><th>OP-PTDA</th><th>color</th><th>articulo</th><th>kg(crudo)</th><th>Tipo</th><th>Turno</th><th>MAQ</th><th>Status</th>`;
        }
