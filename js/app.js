(() => {
    ...
    function getProcessedDateContext(headerCell) {
        ...
        if (getActiveSubtabFilter(viewId) !== 'PROG') {
            return null;
        }
        const columnLabel = getTargetColumnLabel(headerCell);
    ...
    function syncProcessedDateHeaderState(viewId = state.activeView) {
        ...
        const isProg = getActiveSubtabFilter(viewId) === 'PROG';
        ...
        cell.title = override !== null
            ...
            : 'Mostrando ultimos 3 dias con datos. Click derecho para elegir una fecha.';
    }

    function buildProcessedCalendarMarkup() {
        const { year, month, allowed, selected } = processedDateMenuState;
        ...
        return `
            ...
            <button class="pd-clear" type="button" data-pd-clear>Volver a ultimos 3 dias</button>
        `;
    }
