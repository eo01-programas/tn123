(() => {
    ...
    // X PROG (12): P | F_ing_crudo | cliente | tipo_tela | OP-PTDA | color | articulo | kg | ruta | #dias | Turno | Status
    const PLEGADO_XPROG_WIDTHS = [30, 60, 50, 50, 84, 145, 299, 58, 65, 78, 58, 76];
    // PROG  (14): F_ing_crudo | F_plegado | cliente | tipo_tela | OP-PTDA | color | articulo | kg | ruta | #dias | Turno | Supervisor | Equipo | Status
    const PLEGADO_PROG_WIDTHS  = [65, 70, 50, 50, 84, 84, 260, 58, 80, 81, 58, 99, 84, 45];
    ...
    function getVisibleColumnCount() {
        return currentFilter === 'PROG' ? 14 : 12;
    }
