const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxKiDgqpytkwWcGzJgOA04w4QTPj9z70uaOgXRxe-3ye26rc3zpdD4Q92YAClg_15BU/exec';
...
const ACABADO_ESPECIAL_TIPO_OPTIONS = ['', 'NO LLEVA', 'HIDRO-EXTRACTORA', 'SAMTEX', 'SECADO', 'ESMERILADO', 'COMPACTADO', 'PERCHADO'];
const ACABADO_ESPECIAL_TURNO_OPTIONS = ['', '1T', '2T'];
const ACABADO_ESPECIAL_MAQUINA_OPTIONS = [''];
const ACABADO_ESPECIAL_ESTADO_OPTIONS = ['X PROG', 'PROG', 'OK'];
const CALIDAD_TURNO_OPTIONS = ['', '1T', '2T'];
const CALIDAD_ESTADO_OPTIONS = ['X PROG', 'PROG', 'AUDITANDO', 'RECHAZADO', 'OK'];
