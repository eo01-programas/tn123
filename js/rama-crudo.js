(() => {
    ...
    // P | cliente | OP-PTDA | color | cod_art | articulo | kg | Turno | Oper | MAQ | ruta | Insp | Superv | Inicio | Fin | Status
    const RAMA_CRUDO_WIDTHS = [37, 52, 99, 87, 79, 93, 62, 62, 87, 62, 81, 74, 74, 68, 68, 68];
    ...
    function renderSubtabCounts(records) {
        ...
        if (colgroup) colgroup.innerHTML = RAMA_CRUDO_WIDTHS.map(w => `<col style="width:${w}px">`).join('');
    }
