(() => {
    ...
    const ABRIDORA_XPROG_WIDTHS = [30, 60, 60, 50, 78, 112, 255, 56, 45, 65, 70];
    // PROG   (10):  F_abridora | cliente | tela | OP-PTDA | color | articulo | kg | Turno | Oper | Status
    const ABRIDORA_PROG_WIDTHS  = [67, 60, 50, 78, 110, 370, 56, 73, 90, 40];
