(() => {
    ...
    // P | cliente | OP-PTDA | color | articulo | kg | Turno | Oper | Inicio | Fin | Status
    const ABRIDORA_WIDTHS = [36, 50, 59, 112, 157, 78, 78, 123, 95, 95, 95];
    ...
    function renderSubtabCounts(records) {
        ...
        if (colgroup) colgroup.innerHTML = ABRIDORA_WIDTHS.map(w => `<col style="width:${w}px">`).join('');
    }
