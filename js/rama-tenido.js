(() => {
    ...
    // Por procesar (11): P | cliente | OP-PTDA | color | cod_art | articulo | kg | Turno | MAQ | Proceso | Status
    const RAMA_TENIDO_WIDTHS = [37, 72, 108, 100, 90, 220, 68, 60, 72, 85, 95];
        ...
        if (!filtered.length) {
            tbody.innerHTML = `
                <tr class="empty-state">
                    <td colspan="${isProcesado ? 14 : 11}">No hay filas para este subtab.</td>
                </tr>
            `;
