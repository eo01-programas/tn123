...
const Tablero = (() => {
  ...
  /* ---------- Identidad del artículo ----------
     ...
     que es solo la familia deducida de una lista cerrada, sino de las
     columnas reales "Descripcion Art. 1" y "Descripcion Art. 2".
     Esas dos columnas llegan combinadas en "Descripcion Art." separadas
     por doble espacio, y Utils.splitDobleEspacio ya las devuelve en
     r.descArts.
  ...
  /* Descripciones reales de una carga. El doble espacio separa una
     descripción de otra, pero algunas lo llevan DENTRO, así que un
     trozo solo abre descripción nueva si nombra un tipo de tela
     (CONFIG.TIPOS_TELA); si no, continúa la anterior. */
  ...
  function vistaInformacion() {
    ...
    c4.innerHTML = '<h3>Cómo se arma el artículo y el tono</h3>' +
      lista([
        'El <b>artículo</b> es la descripción real de la hoja: <code>Descripcion Art. 1</code> ' +
          'y <code>Descripcion Art. 2</code>. No se usa la columna <code>Articulo</code>, que ' +
        ...
        'Algunas descripciones traen un doble espacio <i>dentro</i>, que es el mismo ' +
          'separador entre artículos. Un trozo abre descripción nueva solo si nombra un tipo ' +
          'de tela de <code>CONFIG.TIPOS_TELA</code>; si no, se reengancha al anterior. Así ' +
          'trozos como <code>PES RECIC 0+40D SPD</code> o <code>FULL MATE</code> no aparecen ' +
          'como artículos inventados.',
