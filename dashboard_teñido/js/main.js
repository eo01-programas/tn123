...
const App = (() => {
  ...
  function mostrarVista(id) {
    ...
    // En Detalle el scroll vertical es de la tabla (encabezados sticky
    // siempre visibles), no del main; ver .sc8-main.vista-tabla en CSS.
    const main = document.querySelector('.sc8-main');
    if (main) main.classList.toggle('vista-tabla', id === 'vistaDetalle');
