...
const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbyKgk9siL-uLExY8eYD-EXfDe80ZP3LE38HjRFBvWObT5xdNNkNB325U7p_BQLVfVaIUw/exec';
...
const CONFIG = {
  ...
  /* ---------- TONO (vista DETALLE / tablero de gestión) ----------
     ...
     se deduce del primer valor de "Colores" con la misma mecánica
  ...
  /* ---------- TIPOS DE TELA (vista DETALLE / tablero) ----------
     Compatibilidad para filas históricas: antes "Descripcion Art."
     separaba los artículos por doble espacio, pero algunas descripciones
